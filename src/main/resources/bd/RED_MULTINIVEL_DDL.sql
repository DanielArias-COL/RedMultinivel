...
INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (7, 'Andrés', 'López', 'andres.lopez@gmail.com', 'andres.lopez', 1, 'CRR22 #5-11', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (8, 'Sofía', 'Cruz', 'sofia.cruz@gmail.com', 'sofia.cruz', 1, 'CRR50 #10-45', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (9, 'Diego', 'Rojas', 'diego.rojas@gmail.com', 'diego.rojas', 1, 'CLL40 #19-22', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (10, 'Camila', 'Vargas', 'camila.vargas@gmail.com', 'camila.vargas', 1, 'CRR12 #2-10', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (11, 'Luis', 'Méndez', 'luis.mendez@gmail.com', 'luis.mendez', 1, 'AV30 #44-14', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (12, 'Elena', 'Peña', 'elena.pena@gmail.com', 'elena.pena', 1, 'CLL35 #21-17', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (13, 'Jorge', 'Santos', 'jorge.santos@gmail.com', 'jorge.santos', 1, 'CLL28 #50-20', 3, 1);



INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (15, 'Diana', 'Moreno', 'diana.moreno@gmail.com', 'diana.moreno', 1, 'CLL5 #6-3', 3, 3);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (16, 'Laura', 'Gómez', 'laura.gomez@gmail.com', 'laura.gomez', 1, 'CRR15 #8-33', 2, 1);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (17, 'Carlos', 'Ruiz', 'carlos.ruiz@gmail.com', 'carlos.ruiz', 1, 'CLL60 #18-12', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (18, 'María', 'Fernández', 'maria.fernandez@gmail.com', 'maria.fernandez', 1, 'AV68 #10-27', 3, 3);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (19, 'Alejandro', 'Martínez', 'alejandro.martinez@gmail.com', 'alejandro.martinez', 1, 'CRR9 #22-9', 3, 3);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (20, 'Valeria', 'Ramírez', 'valeria.ramirez@gmail.com', 'valeria.ramirez', 1, 'CLL25 #16-5', 2, 1);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (21, 'Sebastián', 'Torres', 'sebastian.torres@gmail.com', 'sebastian.torres', 1, 'CRR18 #40-10', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (22, 'Natalia', 'Rojas', 'natalia.rojas@gmail.com', 'natalia.rojas', 1, 'CLL10 #20-30', 3, 2);

INSERT INTO AFFILIATE (AFFILIATE_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, ACTIVATE, ADRRESS, HIERARCHICAL_LEVEL_ID, AFFILIATE_PARENT_ID)
VALUES (23, 'Daniel', 'Castro', 'daniel.castro@gmail.com', 'daniel.castro', 1, 'CRR3 #50-14', 3, 1);
